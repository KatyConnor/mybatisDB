package hx.data.mybatis.javatype;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

/**
 * @author wangmingliang(bob@xyd.cn)
 * @data 2017/8/22 13:40
 */
public class MoneyUtil {
    ...
    public static void main(String[] args) {
        System.out.println(MoneyUtil.moneyFormat("123.2893"));
        System.out.println(MoneyUtil.convert("10101093.23"));
    }
}
